...
p4 = Depart.find_or_create_by(d_name: "Химия")
p5 = Depart.find_or_create_by(d_name: "Программирование")
p6 = Depart.find_or_create_by(d_name: "Русский язык")
...
n3 = Project.find_or_create_by(p_name: "Контрольная работа", cost: 1, time_start: "01-12-2000", time_finish: "02-12-2003")
n4 = Project.find_or_create_by(p_name: "Самостоятельная", cost: 1094, time_start: "01-09-2017", time_finish: "02-12-2017")
n5 = Project.find_or_create_by(p_name: "Проект", cost: 1957, time_start: "10-12-2000", time_finish: "02-12-2016")
